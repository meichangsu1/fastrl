        ...
        **kwargs,
        ...
        if self.use_spec_inference:
            self.speculative_args = {
                ...
                "apdative_speculative_batch_size_threshold": self.config.speculative.bs_threshold,
                "speculative_eagle_mab_configs": self.config.speculative.eagle.get(
                    "mab_configs", ["8_4_32", "8_4_16", "8_4_8"]
                ),
                "speculative_mab_bs_threshold": self.config.speculative.eagle.get("mab_bs_threshold", [1, 2, 5, 21]),
                "max_running_requests": 512 if self.config.speculative.bs_threshold is not None else 64,
