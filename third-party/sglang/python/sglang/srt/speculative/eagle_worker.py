...
class EAGLEWorker(TpModelWorker):
    ...
    def __init__(
        ...
        self.adaptive_spec_consecutive_checks = 0  # Counter for consecutive qualifying checks
        self.adaptive_spec_enabled = False  # Track if speculation is currently enabled
        self.pending_transition_to_sd = False  # Flag to trigger requeue before next batch
    ...
    def forward_batch_generation(self, batch: ScheduleBatch) -> GenerationBatchResult:
        ...
        if batch.forward_mode.is_extend() or batch.is_extend_in_batch:
            ...
            if enable_sd:
                ...
                batch.input_ids = next_token_ids.to(dtype=torch.int64)
