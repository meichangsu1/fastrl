...
class ModelRunner:
    ...
    def init_device_graphs(self, strategy_min_bs: Optional[int] = None, strategy_max_bs: Optional[int] = None):
        ...
        self.graph_runner = graph_runners[self.device](self, strategy_min_bs=strategy_min_bs, strategy_max_bs=strategy_max_bs)
